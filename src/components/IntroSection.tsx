      ...
      <div className="border border-border-strong bg-surface/30 p-6 sm:p-8">
        ...
        <div className="mt-6 pt-4 border-t border-border">
          ...
          <div className="flex flex-wrap gap-2">
            {['Card-as-a-Service', 'BaaS Infrastructure', 'API Platforms', 'Payment Rails', 'Open Banking', 'Behavioral Banking', 'Digital Adoption'].map(
              (spec) => (
                <span
                  key={spec}
          ...
          <div className="font-mono text-[9px] text-text-tertiary uppercase tracking-[0.2em] mb-3 mt-4">
            // how I sell it
          </div>
          <div className="flex flex-wrap gap-2">
            {['Enterprise Sales', 'Go-to-Market', 'Procurement Strategy', 'BD & Partnerships'].map(
              (spec) => (
                <span
                  key={spec}
                  className="font-mono text-[10px] sm:text-[11px] tracking-wider uppercase px-2.5 py-1
