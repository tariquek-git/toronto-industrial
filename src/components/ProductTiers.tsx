    ...
    <section ref={ref} id="tiers" className="scroll-reveal max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="flex flex-col items-center gap-6 sm:hidden stagger-reveal">
        {productTiers.map((tier) => {
          ...
          return (
            <div key={tier.id} className="w-full max-w-[340px]">
              <div
                className="rounded-lg border p-6 flex flex-col transition-all duration-300"
                style={{
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="font-mono text-[9px] text-text-tertiary">#{tier.id}</span>
                </div>
                <h3 className="font-display text-2xl tracking-wider" style={{ color }}>
      ...
      <div
        className="relative hidden sm:flex justify-center items-end gap-0"
      ...
      >
        {productTiers.map((tier, index) => {
          ...
          return (
            <div
              key={tier.id}
              className="relative w-[280px] md:w-[300px] lg:w-[320px] cursor-pointer transition-all duration-300 ease-out"
              style={{
                transform: isHovered
